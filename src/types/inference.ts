...
export function hasSelectionOptions(
  ...
  return (definition.type === 'select' || definition.type === 'multi_select') &&
 ...
 */
export type ExtractSelectionOptions<T extends PropertyDefinition> =
  T extends { type: 'select' | 'multi_select'; options: readonly (infer U)[] }
