...
describe('Unit Tests: Contact Properties', () => {
  describe('Date Property', () => {
    ...
    it('should validate date property values', () => {
      ...
      expect(() => validatePropertyValue(new Date('2024-01-01'), definition, 'DueDate')).not.toThrow();
    ...
    it('should reject invalid date property values', () => {
      ...
      expect(() => validatePropertyValue('2024-01-01', definition, 'DueDate'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue(123456789, definition, 'DueDate'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue({}, definition, 'DueDate'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([], definition, 'DueDate'))
        .toThrow(PropertyValidationError);
    });
  ...
  describe('Email Property', () => {
    ...
    it('should validate email property values', () => {
      ...
      // Valid email formats
      expect(() => validatePropertyValue('user@example.com', definition, 'ContactEmail')).not.toThrow();
      expect(() => validatePropertyValue('test.email+tag@domain.org', definition, 'ContactEmail')).not.toThrow();
      expect(() => validatePropertyValue('user@subdomain.example.com', definition, 'ContactEmail')).not.toThrow();
      expect(() => validatePropertyValue('firstname.lastname@company.co.uk', definition, 'ContactEmail')).not.toThrow();
    ...
    it('should reject invalid email property values', () => {
      ...
      expect(() => validatePropertyValue('invalid-email', definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('user@', definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('@domain.com', definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('user@domain', definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('user space@domain.com', definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue(123, definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([], definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
    });
    ...
    it('should handle edge cases for email validation', () => {
      ...
      expect(() => validatePropertyValue(longEmail, definition, 'ContactEmail'))
        .toThrow(PropertyValidationError);
    });
  });
  ...
  describe('URL Property', () => {
    ...
    it('should validate URL property values', () => {
      ...
      // Valid URL formats
      expect(() => validatePropertyValue('https://example.com', definition, 'WebsiteURL')).not.toThrow();
      expect(() => validatePropertyValue('http://example.com', definition, 'WebsiteURL')).not.toThrow();
      expect(() => validatePropertyValue('https://www.example.com/path?query=value', definition, 'WebsiteURL')).not.toThrow();
      expect(() => validatePropertyValue('http://subdomain.domain.com:8080/path', definition, 'WebsiteURL')).not.toThrow();
      expect(() => validatePropertyValue('https://api.example.com/v1/users/123', definition, 'WebsiteURL')).not.toThrow();
    ...
    it('should reject invalid URL property values', () => {
      ...
      // Invalid URL formats
      expect(() => validatePropertyValue('not-a-url', definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('ftp://example.com', definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('mailto:user@example.com', definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('//example.com', definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue('http://', definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue(123, definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([], definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
    });
    ...
    it('should handle edge cases for URL validation', () => {
      ...
      expect(() => validatePropertyValue('https://', definition, 'WebsiteURL'))
        .toThrow(PropertyValidationError);
    });
  });
  ...
  describe('People Property', () => {
    ...
    it('should validate people property values', () => {
      ...
      expect(() => validatePropertyValue([validUser1, validUser2], definition, 'Assignees')).not.toThrow();
    ...
    it('should reject invalid people property values', () => {
      ...
      expect(() => validatePropertyValue('not-an-array', definition, 'Assignees'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([invalidUser1], definition, 'Assignees'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([invalidUser2], definition, 'Assignees'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([invalidUser3], definition, 'Assignees'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue([{}], definition, 'Assignees'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue(['string'], definition, 'Assignees'))
        .toThrow(PropertyValidationError);
      expect(() => validatePropertyValue(123, definition, 'Assignees'))
        .toThrow(PropertyValidationError);
    ...
    it('should handle mixed valid/invalid user arrays', () => {
      ...
      expect(() => validatePropertyValue([validUser, invalidUser], definition, 'Assignees'))
        .toThrow(PropertyValidationError);
    });
  });
  ...
  describe('Property Type Integration', () => {
    it('should distinguish between different contact property types', () => {
      ...
      expect(() => validatePropertyValue('2024-01-01', dateProperty, 'Date')).toThrow(PropertyValidationError);
      ...
      expect(() => validatePropertyValue('https://example.com', emailProperty, 'Email')).toThrow(PropertyValidationError);
      
      // URL properties only accept valid URL strings
      expect(() => validatePropertyValue('https://example.com', urlProperty, 'URL')).not.toThrow();
      expect(() => validatePropertyValue('user@example.com', urlProperty, 'URL')).toThrow(PropertyValidationError);
      ...
      expect(() => validatePropertyValue(['user-123'], peopleProperty, 'People')).toThrow(PropertyValidationError);
    });
    ...
    it('should handle edge cases for contact properties', () => {
      ...
      expect(() => validatePropertyValue('https://localhost:3000', urlProperty, 'URL')).not.toThrow();
      expect(() => validatePropertyValue('http://192.168.1.1:8080', urlProperty, 'URL')).not.toThrow();
    });
  });
});